...
We'll use the `drop` predicate to represent a large number of potential communication issues, all of which would prevent a server from seeing another's messages. But what should those look like? We'll define them in yet another module: 
